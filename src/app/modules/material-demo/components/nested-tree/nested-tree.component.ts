...
export class NestedTreeComponent implements OnInit {
  ...
  nestedTreeDataSource: MatTreeNestedDataSource<CourseNode> = new MatTreeNestedDataSource<CourseNode>()
  nestedTreeControl = new NestedTreeControl((courseNode: CourseNode) => courseNode.children)
